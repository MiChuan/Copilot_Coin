...
public:
	...
	BacktestResult runFrom1hKlines(const nlohmann::json& klines, double feePerc=0.0004, double slippagePerc=0.0005, double leverage=3.0, double initialBalance=1000.0);
private:
